...
/* @property --aurora-rot removed: Vue SFC tokenizer misparses angle brackets in syntax values. */
.hp-hero-inner::after {
  content: '';
  position: absolute;
  top: -5%;
...
/* ════════════════════════════════
   iOS 移动端响应式 - 重新设计 feed
   ════════════════════════════════ */
@media (max-width: 768px) {
  .desktop-only { display: none !important; }
  .mobile-only { display: flex !important; }
  .home-page { padding-bottom: 5.5rem; }

  /* ── Hero：iOS 风格舒适合排版 ── */
  .hp-hero { padding: 4rem 0.75rem 0.5rem; }
  .hp-hero-inner {
    ...
    margin: 0;
    gap: 0.5rem;
    box-shadow: 0 20px 50px -20px rgba(99, 102, 241, 0.16), 0 0 0 1px rgba(255, 255, 255, 0.3);
  }
  .hp-hero-badge-row {
  ...
  .hp-hero-title { margin-bottom: 0.15rem; font-size: 1.55rem; line-height: 1.12; }
  .hp-hero-sub { margin-bottom: 0.25rem; font-size: 0.88rem; line-height: 1.5; max-width: 100%; }
  .hp-hero-actions { gap: 0.55rem; margin-bottom: 0.35rem; }
  .hp-btn-primary { padding: 0.62rem 1.2rem; font-size: 0.85rem; min-height: 44px; border-radius: 12px; }
  ...
  .hp-ai-mobile-input { padding: 0.28rem 0.35rem 0.28rem 0.65rem; }
  .hp-ai-mobile-send { width: 1.6rem; height: 1.6rem; }

  /* Hero chips */
  .hp-hero-chip-row { margin-top: 0.25rem; gap: 0.4rem; justify-content: flex-start; }
  .hp-hero-primary-mobile { font-size: 0.78rem; padding: 0.48rem 0.95rem; min-height: 44px; border-radius: 12px; }
  .hp-hero-chip { padding: 0.38rem 0.65rem; font-size: 0.74rem; min-height: 36px; }

  /* ── 文章区域间距 ── */
  .hp-posts { padding: 1rem 0 2rem; }
  .hp-posts-inner { padding: 0 0.75rem; }
  .hp-section-title { font-size: 1.1rem; }

  /* ── 话题筛选：iOS 风格横向滚动 pills ── */
  .hp-topic-filter-row {
    gap: 0.4rem;
  ...
  /* ── Feature Card：单列，封面在上 ── */
  .hp-feature-card {
    grid-template-columns: 1fr;
    border-radius: 14px;
  }
  .hp-feature-cover { min-height: 13rem; }
  .hp-feature-body { padding: 1.1rem 1.1rem 1.25rem; gap: 0.55rem; }
  .hp-feature-kicker { font-size: 0.7rem; }
  .hp-feature-title { font-size: 1.2rem; }
  .hp-feature-summary { font-size: 0.88rem; line-height: 1.6; }
  .hp-feature-read { font-size: 0.8rem; padding: 0.55rem 1rem; min-height: 40px; }

  /* ── Spotlight：单列大图卡片（iOS News 风格） ── */
  .hp-spotlight-grid {
    grid-template-columns: 1fr;
    gap: 0.85rem;
  }
  .hp-spotlight-card { border-radius: 14px; }
  .hp-spotlight-cover { aspect-ratio: 16 / 9; }
  .hp-spotlight-body { padding: 1rem 1.1rem 1.1rem; gap: 0.5rem; }
  .hp-spotlight-title { font-size: 1.05rem; line-height: 1.3; }
  .hp-spotlight-summary { font-size: 0.85rem; line-height: 1.6; }

  /* ── Compact：单列，小缩略图 + 文字横向 ── */
  .hp-compact-grid {
    grid-template-columns: 1fr;
    gap: 0.5rem;
  }
...
@media (max-width: 420px) {
  .hp-hero { padding: 3.5rem 0.5rem 0.25rem; }
  .hp-hero-inner { padding: 1rem 0.85rem 0.9rem; }
  .hp-hero-title { font-size: 1.4rem; }
  .hp-hero-sub { font-size: 0.82rem; }
  .hp-posts-inner { padding: 0 0.5rem; }
  .hp-post-cover { width: 4rem; min-height: 4rem; border-radius: 9px; }
  .hp-post-item { padding: 0.6rem 0.65rem; gap: 0.65rem; }
  .hp-post-title { font-size: 0.9rem; }
  .hp-post-summary { font-size: 0.76rem; }
  .hp-feature-cover { min-height: 11rem; }
  .hp-spotlight-cover { aspect-ratio: 5 / 3; }
}
</style>